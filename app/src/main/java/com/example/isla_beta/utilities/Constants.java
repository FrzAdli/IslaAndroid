...
public class Constants {
    ...
    public static final String KEY_MESSAGE_TYPE_VIDEO = "VideoMessage";
    public static final String KEY_ENCODED_IMAGE = "encodedImage";
    public static final String KEY_VIDEO_URL = "videoUrl";

    public static final String KEY_USER_CONVERSATION = "userConversation";

    public static final String KEY_OPENAI = "api_openai";
    public static final String KEY_PRODIA = "api_prodia";
}
