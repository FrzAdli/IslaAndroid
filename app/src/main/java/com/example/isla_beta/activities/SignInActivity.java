...
import com.example.isla_beta.databinding.ActivitySignInBinding;
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful() && task.getResult() != null
                        ...
                        preferenceManager.putString(Constants.KEY_OPENAI, documentSnapshot.getString(Constants.KEY_OPENAI));
                        preferenceManager.putString(Constants.KEY_PRODIA, documentSnapshot.getString(Constants.KEY_PRODIA));
                        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
